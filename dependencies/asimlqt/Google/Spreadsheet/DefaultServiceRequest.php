...
class DefaultServiceRequest implements ServiceRequestInterface
{
    ...
    {   
        ...
        // echo htmlentities($postData); die();
        return $this->execute($ch);
    }
     ...
     * @return string
     */
    public function put($url, $postData, $addIfMatch = false)
    {
        $headers = array(
            'Content-Type: application/atom+xml',
            'Content-Length: ' . strlen($postData),
    ...
    protected function initRequest($url, $requestHeaders = array())
    {
        ...
        $headers[] = "Gdata-version: 3.0"; // added by @aravindanve
        // $headers[] = "If-Match: *"; // added by @aravindanve
